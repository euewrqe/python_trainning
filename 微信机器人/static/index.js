...
webpackJsonp([1], [function (e, exports, t) {
    ...
    angular.module("Controllers", []), t(278), t(279), t(280), t(282), t(283), t(285), t(286), t(287), t(288), t(289), t(290), t(291), angular.module("Services", []), t(292), t(293), t(294), t(295), t(296), t(297), t(298), t(299), t(300), t(301), t(302), t(303), t(304), t(305), t(306), t(307), t(308), t(310), t(311), t(312), t(313), angular.module("Directives", []), t(314), t(315), t(316), t(317), t(318), t(319), t(320), t(321), t(322), t(323), t(324), t(325), t(326), t(327), t(328), t(329), t(330), t(331), t(332), t(333), t(334), t(335), t(336), t(337), t(338), t(339), angular.module("Filters", []), t(341), t(342), function () {
        "use strict";
        ...
        location.href.indexOf("dev.web") < 0 ? angular.module("exceptionOverride", []).factory("$exceptionHandler", [function () {
            ...
            function N() {
                t.isLoaded = !0, t.isUnLogin = !1, M.report(M.ReportType.timing, {timing: {initStart: Date.now()}}), s.init().then(function (n) {
                    ...
                    f.setUserInfo(n.User), f.setSkey(n.SKey), f.setSyncKey(n.SyncKey), d.addContact(n.User), d.addContacts(n.ContactList), u.initChatList(n.ChatSet), u.notifyMobile(f.getUserName(), m.StatusNotifyCode_INITED), C.init(n.MPSubscribeMsgList), e.$broadcast("root:pageInit:success"), h.setCheckUrl(f), h.log("getUserInfo", f.getUserInfo()), t.$broadcast("updateUser"), M.report(M.ReportType.timing, {timing: {initEnd: Date.now()}});
            ...
            function k(e) {
                var t = h.getCookie("last_wxuin") || "", a = parseInt(h.getCookie("login_frequency") || 1);
            ...
            i.go("chat"), e.CONF = m, t.isUnLogin = !window.MMCgi.isLogin, t.debug = !0, t.isShowReader = /qq\.com/gi.test(location.href), window.MMCgi.isLogin && (N(), h.browser.chrome && !MMDEV && (window.onbeforeunload = function (e) {
                return e = e || window.event, e && (e.returnValue = "鍏抽棴娴忚鍣ㄨ亰澶╁唴瀹瑰皢浼氫涪澶便€�"), "鍏抽棴娴忚鍣ㄨ亰澶╁唴瀹瑰皢浼氫涪澶便€�"
                ...
                switch (c.code) {
                    case 200:
                        t.newLoginPage(c.redirect_uri).then(function (t) {
                            var o = t.match(/<ret>(.*)<\/ret>/), r = t.match(/<script>(.*)<\/script>/), c = t.match(/<skey>(.*)<\/skey>/), s = t.match(/<wxsid>(.*)<\/wxsid>/), l = t.match(/<wxuin>(.*)<\/wxuin>/), d = t.match(/<pass_ticket>(.*)<\/pass_ticket>/), f = t.match(/<message>(.*)<\/message>/), u = t.match(/<redirecturl>(.*)<\/redirecturl>/);
                            return u ? void(window.location.href = u[1]) : o && "0" != o[1] ? (alert(f && f[1] || "鐧婚檰澶辫触"), i.report(i.AUTH_FAIL_COUNT, 1), void location.reload()) : (e.$emit("newLoginPage", {
                                Ret: o && o[1],
                                SKey: c && c[1],
                                Sid: s && s[1],
                                Uin: l && l[1],
    ...
    !function () {
        ...
        angular.module("Controllers").controller("chatSenderController", ["$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService", "monitorService", function (e, a, n, i, o, r, c, s, l, d, f, u, m, g, p, h) {
            function M() {
                var e = "undefined" != typeof x.textContent ? x.textContent : x.innerText, t = x.getElementsByTagName("img").length > 0;
                            ...
                            return K.md5File(e).then(function (t) {
                                ...
                                if (i) {
                                    ...
                                    d = angular.extend({}, u), n({
                                        ...
                                        e.MMSendMsg && (e.MMSendMsg.MMFileStatus = r.MM_SEND_FILE_STATUS_FAIL, e.MMSendMsg.MMStatus = r.MSG_SEND_STATUS_FAIL), alert("涓婁紶澶辫触")
                                    })
        ...
        angular.module("Controllers").controller("createChatroomController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", "monitorService", function (e, t, a, n, i, o, r, c, s, l, d, f, u, m, g, p, h) {
            a(function () {
                t.ngDialogData.isCreate && (M = []), t.allContacts = c.pickContacts(["star", "friend"], {
                    ...
                    friend: {filterContacts: M, isWithoutStar: !0, isWithoutBrand: !0}
            ...
            function u(e) {
                ...
                for (var n = [e.target], i = e.path || e.originalEvent.path || a(e.target), o = 0, r = i.length; o < r; o++) {
                    ...
                    if (c) {
                        ...
                        var s = angular.element(document.getElementById("contextMenu")), l = angular.element(window), d = s.width(), f = s.height(), u = l.width(), M = l.height();
                ...
                switch (t.contextMenuList = [], (!g._noSupportMsg || g.AppMsgType != o.APPMSGTYPE_TRANSFERS && g.AppMsgType != o.APPMSGTYPE_REALTIME_SHARE_LOCATION && g.AppMsgType != o.APPMSGTYPE_CARD_TICKET) && ("filehelper" != g.MMPeerUserName && i.getUserName() == g.FromUserName && Date.now() / 1e3 - g.CreateTime < 120 ? t.contextMenuList.push({
                    ...
                    case o.MSGTYPE_TEXT:
                        ...
                        p = v ? v + ":" + g.MMActualContent : g.MMActualContent, p = p.replace(":", ": "), t.contextMenuList.push({
                            content: _("3b61c96"),
                            callback: function () {
                                var t = [_("d9eb6f5"), p, _("83b6d34"), "<br>鈥斺€斺€斺€斺€斺€斺€斺€斺€�<br>"].join("");
    ...
    !function () {
        ...
        angular.module("Controllers").controller("editAreaContactListController", ["$scope", "confFactory", "utilFactory", "$timeout", function (e, t, a, n) {
            ...
            var r = document.getElementById("editArea"), c = document.getElementById("editAreaContactPanel"), s = document.getElementById("caretPosHelper"), l = e.memberList.length - 1, d = 42, f = 10;
                ...
                n.open({
                    templateUrl: "feedback.html", controller: ["$scope", function (e) {
                        e.content = "", e.send = function () {
                            var t = "銆愭柊鐗坵eb寰俊銆戙€�" + navigator.userAgent.toLowerCase() + "銆�" + e.content;
        ...
        angular.module("Controllers").controller("transpondDialogController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function (e, t, a, n, i, o, r, c, s, l, d, f, u, m, g, p) {
            ...
            v.unshift({text: _("b3b6735"), type: "header"}), t.initList = v, t.ensure = function () {
                ...
                if (e > 0) {
                    ...
                    if (e > 200)return void alert("閫夋嫨鐨勪汉鏁板繀椤诲皯浜�200");
                    t.comfirming = !0
                }
            }
        }])
        ...
        angular.module("Services").factory("appFactory", ["$http", "$q", "confFactory", "accountFactory", "loginFactory", "utilFactory", "reportService", "mmHttp", function (e, t, a, n, i, o, r, c) {
            var s = {
                globalData: {chatList: []}, init: function () {
                    ...
                    var e = t.defer(), c = this, s = a.API_synccheck + "?" + ["r=" + o.now(), "skey=" + encodeURIComponent(n.getSkey()), "sid=" + encodeURIComponent(n.getSid()), "uin=" + n.getUin(), "deviceid=" + n.getDeviceID(), "synckey=" + encodeURIComponent(n.getFormateSyncCheckKey())].join("&");
                    return window.synccheck && (window.synccheck.selector = 0), $.ajax({
                        ...
                        }) : e.reject(window.synccheck && window.synccheck.selector) : !window.synccheck || "1101" != window.synccheck.retcode && "1102" != window.synccheck.retcode ? window.synccheck && "1100" == window.synccheck.retcode ? i.loginout(0) : (e.reject("syncCheck net error"), r.report(r.ReportType.netError, {
                ...
                setCurrentUserName: function (e) {
                    ...
                    if (t && a) {
                        ...
                        return o && r || utilFactory.reportSendState("sendcheckAttrError"), e || utilFactory.reportSendState("toUserNameNotFound"), !(!e || o != r || r != e) || (r != e && utilFactory.reportSendState("toUserNameConflictNav"), o != e && utilFactory.reportSendState("toUserNameConflictChat"), utilFactory.reportSendState("uiCheckFail"), reportService.report(reportService.ReportType.sendError, {
                            ...
                            values: {chatuser: o, navuser: r, userName: e}
                        }), !1)
                    }
                    ...
                    if (e) {
                        var t = this, a = (e.FromUserName, e.ToUserName, _chatMessages[e.MMPeerUserName] || (_chatMessages[e.MMPeerUserName] = []));
                    ...
                    this._appAsTextMsgProcess(e, "[鏀跺埌涓€鏉＄綉椤电増寰俊鏆備笉鏀寔鐨勬秷鎭被鍨嬶紝璇峰湪鎵嬫満涓婃煡鐪媇")
                    ...
                    function t() {
                        for (var t = contactFactory.getContact(e.MMPeerUserName), a = t ? t.getDisplayName(e.MMPeerUserName) : "", n = t ? t.HeadImgUrl : "", i = e.MMDigest.replace(/(<img.*?\/>)|<span class="emoji.*?<\/span>/g, _("809bb9d")), o = utilFactory.clearHtmlStr(i), r = "", c = 80, s = 0, l = 0; l < o.length; l++) {
                            if (s += o.charCodeAt(l) <= 128 ? 1 : 2, s >= c) {
                                r = o.slice(0, l + 1), l < o.length - 1 && (r += "鈥�");
                                break
                            }
                            r = o
                        }
                    ...
                    $http({
                        ...
                        0 == a.BaseResponse.Ret ? (angular.extend(e, {
                            ...
                            _h: 0
                        }), t.getChatList()) : alert(a.BaseResponse.ErrMsg || "鎾ゅ洖澶辫触")
                    }).error(function (e) {
                        alert("鎾ゅ洖澶辫触")
                    })
        ...
        angular.module("Services").factory("chatroomFactory", ["$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "utilFactory", "reportService", "mmHttp", function (e, t, a, n, i, o, r, c, s, l, d) {
            var f, u = {}, m = {
                setCurrentContact: function (e) {
                    ...
                    var t = n.defer(), i = angular.extend({
        ...
        angular.module("Services").factory("contactFactory", ["$rootScope", "$http", "$q", "$timeout", "confFactory", "accountFactory", "emojiFactory", "utilFactory", "resourceService", "reportService", "mmHttp", function (e, t, a, n, i, o, r, c, s, l, d) {
            ...
            var u, m = window._contacts = {}, g = window._strangerContacts = {}, p = [], h = [], M = [], v = [], y = window._chatRoomMemberDisplayNames = {}, b = [], C = [], w = [], S = {}, T = {}, N = 0, E = ["fmessage"], G = {
                isSelf: function () {
                    ...
                    if (!e)return !0;
                    e = e.toUpperCase();
                    var a = this.RemarkName || "", n = this.RemarkPYQuanPin || "", i = this.NickName || "", o = this.PYQuanPin || "", r = this.Alias || "", c = this.KeyWord || "", s = 0, l = 0;
                ...
                contactChangeFlag: "", setCurrentContact: function (e) {
                    ...
                    return t({
                        ...
                        n.reject("error:" + e), l.report(l.ReportType.netError, {
                            text: "init contact",
                            url: i.API_webwxgetcontact,
                            params: {skey: o.getSkey(), pass_ticket: o.getPassticket()}
                        })
                    }), n.promise
                    ...
                    return w.length ? (r = w.length < 6 || N > 2 ? 1 : w.length < 40 ? 5 : 10, C = w.splice(0, r)) : C = b.splice(0, 50), t({
                        ...
                        data: angular.extend(o.getBaseRequest(), {Count: C.length, List: C})
                    }).success(function (t) {
    ...
    !function () {
        ...
        angular.module("Services").factory("notificationFactory", ["utilFactory", function (e) {
            ...
            var s = "default", l = "granted", d = "denied", f = [l, s, d], u = {
                pageVisibility: !1,
                autoClose: 5e3,
                total: 3
            }, m = "", g = function () {
    ...
    !function (t, a) {
        ...
        return function (e) {
            ...
            "use strict";
            function n(e, t) {
                var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, n = void 0, i = void 0, o = void 0, r = 0, c = function () {
    ...
    !function () {
        ...
        angular.module("Services").factory("mmHttp", ["$http", "$q", "$timeout", function (e, t, a) {
            function n(n) {
                ...
                var l = n.data, d = n.config, f = d.MMRetry, u = "undefined" == typeof f.count ? 3 : f.count, m = f.timeout || 15e3, g = f.serial, p = [], h = [], M = 0, v = t.defer(), y = 0;
                    ...
                    n.bind("paste", function () {
                        ...
                        s && clearTimeout(s), s = setTimeout(function () {
                            ...
                            if (l != -1 && d != -1) {
                                ...
                                var g = c.substring(l, d + 1), p = c.substr(0, l), h = c.substr(l + g.length), M = p.lastIndexOf("<"), v = p.lastIndexOf(">");
    ...
    angular.module("Directives").directive("previewDirective", ["$document", "confFactory", "utilFactory", function (e, t, a) {
        return {
            ...
            link: function (n, i, o) {
                ...
                function f() {
                    m.on("mousedown", function (e) {
                        ...
                        "mousewheel" != a.type && "DOMMouseScroll" != a.type || (t = a.wheelDelta ? a.wheelDelta / 120 : -(a.detail || 0) / 3), void 0 !== t && (s(G ? {delta: t} : {
                            delta: t,
                            posRatio: {x: a.offsetX / y.width, y: a.offsetY / y.height}
                        }), e.preventDefault(), e.stopPropagation())
                    }), e.keydown(c)
                }
                ...
                var m = i.find("#img_dom"), g = i.find("#img_opr_container"), p = m.find("#img_preview"), h = document.documentElement.clientWidth, M = document.documentElement.clientHeight - parseInt(g.css("bottom")) - parseInt(g.height());
            ...
            $get: ["$rootScope", "$document", "$compile", function (e, t, a) {
                var n = {
                    open: function (i) {
                        ...
                        var c = angular.element('<div preview-directive class="J_Preview" current="current" image-list="imageList"></div>'), s = a(c)(r), l = t.find("body").eq(0);
                        l.append(s);
                        var d = {
                            close: function () {
                                var e = s.scope();
    ...
    !function (o, r) {
        ...
        "use strict";
        var a = e.module("ngDialog", []), n = e.element, i = e.isDefined, o = (document.body || document.documentElement).style, r = i(o.animation) || i(o.WebkitAnimation) || i(o.MozAnimation) || i(o.MsAnimation) || i(o.OAnimation), c = "animationend webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend", s = !1;
                    ...
                    open: function (r) {
                        ...
                        return m.when(s(w.template || w.templateUrl)).then(function (t) {
                            ...
                            if (E.closeThisDialog = function (e) {
                                    ...
                                    var t = !!w.closeByDocument && n(e.target).hasClass("ngdialog-overlay"), a = n(e.target).hasClass("ngdialog-close");
        ...
        return {
            restrict: "EA", priority: 1e3, scope: !0, terminal: !0, link: function (e, a, n) {
                var i = [], o = {
                    ...
                    size: 0,
                    visible: 687
                }, f = n.mmRepeat.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), u = f[2], m = (f[1], '<div ng-style="{height:topHeight}" class="top-placeholder"></div><div ng-repeat="' + n.mmRepeat + '">' + a.html() + '</div><div ng-style="{height:bottomHeight}" class="bottom-placeholder"></div>'), g = t(m)(e);
    ...
    angular.module("Directives").directive("mmActionTrack", ["actionTrack", "utilFactory", function (e, t) {
        ...
        return a.on("resize", function (o) {
            t.fitRun("resize", function () {
                var t = a.height(), o = a.width(), r = [], c = "height-" + (n > t ? "smaller" : "bigger"), s = "width-" + (i > o ? "smaller" : "bigger");
